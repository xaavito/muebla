Public Class NotaCreditoBE
    ...
    Private _detalles As List(Of BE.NotaCreditoDetalleBE)
    ...
    Public Property detalles() As List(Of BE.NotaCreditoDetalleBE)
        Get
            Return _detalles
        End Get
        Set(ByVal value As List(Of BE.NotaCreditoDetalleBE))
            _detalles = value
        End Set
    End Property
