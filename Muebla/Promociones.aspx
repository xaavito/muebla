<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="Promociones.aspx.vb" Inherits="Muebla.Promociones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="Button3" type="button" text="Generar Promocion" OnClick="Button3_Click" runat="server" />
</asp:Content>
